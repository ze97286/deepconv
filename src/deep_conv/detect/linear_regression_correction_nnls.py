...
predictions = predictions[['sample','OAC']]
predictions['estimated'] = predictions['OAC']
...
comparison_df.to_csv("/users/zetzioni/sharedscratch/loyfer_atlas/OAC/analysis/AB/cfDNA/nnls/corrected_estimates.csv", index=False)
...
fig.write_html("/users/zetzioni/sharedscratch/loyfer_atlas/OAC/analysis/AB/cfDNA/nnls/linear_regression.html")                   
