...
def parse_args():
    ...
    if args.name:
        ...
        dir_name = f"aggregator_model_{timestamp}"
        ...
        for i, batch_data in train_bar:
            ...
            if (i + 1) % args.grad_accum_steps == 0 or (i + 1) == len(train_loader):
                ...
                if total_grad_norm > 10.0:
                    ...
                    raise RuntimeError("Training unstable - NaN/Inf gradients detected")
...
def main():
    ...
    logger.info("\n" + "="*60)
    logger.info("AGGREGATOR MODEL TRAINING COMPLETED SUCCESSFULLY")
